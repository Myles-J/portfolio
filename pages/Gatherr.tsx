		...
		<div id='caseStudy'>
			...
			<div className=' m-auto w-90' id='Overview'>
				...
				<p className='w-90'>
					...
					Google Calendar API. Gatherr uses Serverless and AWS Lambda functions to authenticate users with their Google accounts. From there, users
					can view all the events provided by the API, search for events in specific cities, and limit the query results to a number between one and
				...
				<ol>
					<li>
						First, receive a consumer token from the Google Calendar API. Then, using <b>AWS Lambda</b> and <b>Serverless</b>, refresh the access
			...
			<div className=' m-auto w-90' id='Structure'>
				...
				<div className='divider'>
					<ul>
						...
						<li>
							Using <b>AWS</b> and <b>Serverless</b>, create a simple function that refreshes the access token to grant user access to the
							application.
						</li>
					</ul>
			...
			<div className=' w-90 m-auto' id='Reflection'>
				...
				<p>
					...
					serverless applications like Gatherr. Additionally, developing this project with a test-driven approach proved to be a good experience.
				...
				<p>
					The development process brought with it some challenges. When using AWS Lambda and Serverless, the biggest challenge was I faced initially
					was ensuring that my functions worked properly the Google Calendar API. It would seem that each time I made a request to get an
					authentication token, some issue would arise that prevented that token from generating. Because of the fact that the syntax for generating
					such a token is very specific, it took me sometime to wrap my mind around how this process was meant to work. After some trial and error, I
					was able to solve this issue by exploring the AWS and Google Calendar API documentation to ensure my code was setup properly.
				</p>
				<p>
				...
				<h2>Duration</h2>
				<p>
					The development of Gatherr took about three weeks from start to finish. Most of the development time was spent on learning the ins and outs
					of test-driven development and using AWS Lambda functions.
				</p>
				<h2>Credits</h2>
				<ul className='list-unstyled'>
