    ...
    <section id="projects">
          ...
          <div className="details">
            ...
            <div className="project-links">
              ...
              >
              <a href="https://filmfever.netlify.app/" target="_blank">View Live</a>
            </div>
          </div>
          	<br/>
          <h5>React | Redux | SCSS | React-Bootstrap | MongoDB | Node.js | Express.js </h5>
          ...
          <div className="details">
            ...
            <div className="project-links">
              <a
                ...
                >View code on GitHub</a
              >
              <a href="https://myles-the-coder.github.io/Gatherr/" target="_blank"
                >View Live</a
              >
            </div>
          </div>
          <br/>
          <h5>React | Serverless | AWS | Data Visualization | Test-Driven (Just, Cucumber, Puppeteer) | Google OAuth</h5>
				</div>
