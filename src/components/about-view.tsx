export const AboutView = () => (
	<section id="about" className="prose min-h-screen px-2">
		...
		<p>
			...
			{new Date().getFullYear() - 2022} years working on a variety of projects,
			from small web applications to large-scale enterprise systems. I have been
			able to collaborate with clients and team members to ensure that projects
			are completed on time, within budget, and to the highest standards of
